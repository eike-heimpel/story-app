import {
  CharactersSchema,
  type CharactersRecord,
  type CharactersCollectionParam,
  charactersRecordDescription,
  charactersCollection,
} from "./characters";
import {
  PlotsSchema,
  type PlotsRecord,
  type PlotsCollectionParam,
  plotsRecordDescription,
  plotsCollection,
} from "./plots";
import {
  PreviousChatsSchema,
  type PreviousChatsRecord,
  type PreviousChatsCollectionParam,
  previousChatsRecordDescription,
  previousChatsCollection,
} from "./previous_chats";
