...
export type PromptInfoResponse<Texpand = unknown> = Required<PromptInfoRecord> & BaseSystemFields<Texpand>
...
export type CollectionResponses = {
	...
	prompt_info: PromptInfoResponse
	test: TestResponse
	users: UsersResponse
}